...
// Auto-senses if I've made a change to the requires above and adds them to
// the package.json file, I think.
...
const common = {
  ...
  // Add resolve.extensions for babel.
...
// Configuration for the finished product.
if(TARGET === 'build') {
  module.exports = merge(common, {});
}
